...
<input type="hidden" id="rurl" name="rurl" value="<?=my64encode($_SERVER['REQUEST_URI'])?>" />
  ...
  <tr>
    ...
    <td width="200" background="/img/bbg.jpg"><font color="#FFFFFF"><b><a href="#" onClick="shop_view('<?=$shop_idx?>');"><font color="#FFFF00"><?=$shop_name?></font></a></b> <?=$shop_medal_str?></font></td>
    ...
    <td width="610" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td style="PADDING-top: 10px;PADDING-bottom: 10px;PADDING-left: 0px;PADDING-right: 10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="bigtitle "><font color="#00CC33">[<?=$shop_name?>]</font><font color="414141"><?=$p_title?></font></td>
            </tr>
          <tr>
            <td height="10"></td>
            </tr>
...
<div id="ProductGiftAfterArea"></div>
<br>
