...
while ( $row = $mainconn->fetch($res) ) {
	...
	<table width='645' border='0' cellspacing='0' cellpadding='0'>
		<tr>
			...
			<td width='102' align='center' class='shopname'><a  onClick=\"MM_showHideLayers($param_show);\" style='cursor:hand;' />$shop_name</a></td>
	...
	// 샵 정보 레이어
	$TXT .= getLayerShopInfo("shopview", $cnt, 2, 1, 425, -122, $rp_total_rank, $shop_url, $shop_name, $shop_mem_id, $param_hide);
