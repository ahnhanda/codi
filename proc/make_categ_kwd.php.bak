...
foreach ( $P_CATEG as $k => $v ) {
	...
	<table width='645' height='48' border='0' cellpadding='0' cellspacing='0'>
		<tr>
			<td><a href='#' onClick=\"loadCategKwdList('','','',1,'A','','');\" onmouseover=\"chg_main_categ('');\"><img src='/img/list_01.gif' width='113' height='48' border='0' /></a></td>
			<td><a href='#' onClick=\"loadCategKwdList('T','','',1,'A','','');\" onmouseover=\"chg_main_categ('T');\"><img src='/img/{$ct_img}' width='87' height='48' border='0' /></td>
			<td><a href='#' onClick=\"loadCategKwdList('B','','',1,'A','','');\" onmouseover=\"chg_main_categ('B');\"><img src='/img/{$cb_img}' width='89' height='48' border='0'></a></td>
			<td><a href='#' onClick=\"loadCategKwdList('O','','',1,'A','','');\" onmouseover=\"chg_main_categ('O');\"><img src='/img/{$co_img}' width='130' height='48' border='0'></a></td>
			<td><a href='#' onClick=\"loadCategKwdList('U','','',1,'A','','');\" onmouseover=\"chg_main_categ('U');\"><img src='/img/{$cu_img}' width='133' height='48' border='0'></a></td>
			<td><a href='#' onClick=\"loadCategKwdList('A','','',1,'A','','');\" onmouseover=\"chg_main_categ('A');\"><img src='/img/{$ca_img}' width='93' height='48' border='0'></a></td>
		</tr>
	</table>
	";
	...
	<table width='645' border='0' cellspacing='0' cellpadding='0'>
		<tr>
			...
			<table width='600' border='0' cellspacing='0' cellpadding='0'>
				<tr>
					<td width='80'><b><font color='#333333'><img src='/img/icon001.gif' align='absmiddle'> 스타일별</font></b></td>
				...
				<tr>
					<td><b><font color='#333333'><img src='/img/icon002.gif' align='absmiddle'> 아이템별</font></b></td>
				...
				<tr>
					<td><b><font color='#333333'><img src='/img/icon003.gif' align='absmiddle'> 테 마 별</font></b></td>
...
<table width='645' height='48' border='0' cellpadding='0' cellspacing='0'>
	<tr>
		<td><a href='#' onClick=\"loadCategKwdList('','','',1,'A','','');\" onmouseover=\"chg_main_categ('');\"><img src='/img/list01_ov_01.gif' width='113' height='48' border='0' /></a></td>
		<td><a href='#' onClick=\"loadCategKwdList('T','','',1,'A','','');\" onmouseover=\"chg_main_categ('T');\"><img src='/img/list_02.gif' width='87' height='48' border='0' /></td>
		<td><a href='#' onClick=\"loadCategKwdList('B','','',1,'A','','');\" onmouseover=\"chg_main_categ('B');\"><img src='/img/list_03.gif' width='89' height='48' border='0'></a></td>
		<td><a href='#' onClick=\"loadCategKwdList('O','','',1,'A','','');\" onmouseover=\"chg_main_categ('O');\"><img src='/img/list_04.gif' width='130' height='48' border='0'></a></td>
		<td><a href='#' onClick=\"loadCategKwdList('U','','',1,'A','','');\" onmouseover=\"chg_main_categ('U');\"><img src='/img/list_05.gif' width='133' height='48' border='0'></a></td>
		<td><a href='#' onClick=\"loadCategKwdList('A','','',1,'A','','');\" onmouseover=\"chg_main_categ('A');\"><img src='/img/list_06.gif' width='93' height='48' border='0'></a></td>
	</tr>
</table>
<table width='645' border='0' cellspacing='0' cellpadding='0'>
	<tr>
