	...
	<td bgcolor='C8C8C8' style='padding:1 1 1 1'><table width='100%' border='0' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF'>
		<tr>
		  <td style='padding:15 15 15 15'><table width='100%' border='0' cellspacing='0' cellpadding='0' style='border:1 dotted #BFBFBF;'>
			  <tr>
				<td style='padding:10 10 10 10' class='intext'><img src='" . __HTTPURL__  . "/img/icon_book.gif' width='14' height='15'  align='absmiddle' /> <b><font color='#00CC33'><u>베스트 샵 </u></font></b> : 코디탑텐에서 회원님들께 높은 평가를 받은 <b><font color='#FF5C5C'><u>샾들의 순위</u></font></b>를 확인하실 수 있습니다. 샾이 등록한 모든 코디들의  <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;평가점수를 기준으로 순위가 결정됩니다.</td>
			  </tr>
		  </table></td>
		</tr>
	</table></td>
...
<table width='645' border='0' cellspacing='0' cellpadding='0'>
	<tr>
		<td width='129'><a href='#' onClick=\"loadShopRankSub('weekly','$this_w_first','$key','$kwd');\" onmouseout='MM_swapImgRestore()' onmouseover=\"MM_swapImage('Image52','','/img/tap_codi_ov_01.gif',1);\"><img src='" . __HTTPURL__  . "/img/{$term_tab_1}' name='Image52' width='129' height='30' border='0' id='Image52' /></a></td>
		<td width='130'><a href='#' onClick=\"loadShopRankSub('monthly','$this_m_first','$key','$kwd');\" onmouseout='MM_swapImgRestore()' onmouseover=\"MM_swapImage('Image53','','/img/tap_codi_ov_02.gif',1);\"><img src='" . __HTTPURL__  . "/img/{$term_tab_2}' name='Image53' width='131' height='30' border='0' id='Image53' /></a></td>
		<td width='130'><a href='#' onClick=\"loadShopRankSub('','','$key','$kwd');\" onmouseout='MM_swapImgRestore()' onmouseover=\"MM_swapImage('Image56','','/img/tap_codi_ov_04.gif',1);\"><img src='" . __HTTPURL__  . "/img/{$term_tab_3}' name='Image56' width='131' height='30' border='0' id='Image56' /></a></td>
...
if ( $term ) {
	$str .= "
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				<td width='62'><a href='#' onClick=\"loadShopRankSub('$term','$ptr_prev_first','$key','$kwd');\"><!--<img src='" . __HTTPURL__  . "/img/btn_a01.gif' width='50' height='14' border='0'>--><font size='-2'>".str_replace("-",".",$ptr_prev_first)."<br>".str_replace("-",".",$ptr_prev_last)."</font></a></td>
				<td width='62'><a href='#' onClick=\"loadShopRankSub('$term','$f_date','$key','$kwd');\"><!--<img src='" . __HTTPURL__  . "/img/btn_a03.gif' width='50' height='14' border='0'>--><font size='-2'>".str_replace("-",".",$f_date)."<br>".str_replace("-",".",$l_date)."</font></a></td>
				<td><a href='#' onClick=\"loadShopRankSub('$term','$ptr_next_first','$key','$kwd');\"><!--<img src='" . __HTTPURL__  . "/img/btn_a02.gif' width='50' height='14' border='0'>--><font size='-2'>".str_replace("-",".",$ptr_next_first)."<br>".str_replace("-",".",$ptr_next_last)."</font></a></td>
			</tr>
		</table>
	";
} else {
...
while ( $row = $mainconn->fetch($res) ) {
	...
	if ( $cnt == 1 ) {
				...
				<table width='100%' border='0' cellspacing='0' cellpadding='0'>
					<tr>
						...
						<table width='160' border='0' cellspacing='0' cellpadding='0'>
							...
							<tr>
								<td><a href='#' onClick=\"MM_showHideLayers($param_show);\"><img src='" . __HTTPURL__  . "$shop_logo' width='160' height='160' border='0' /></a></td>
							</tr>
							<tr>
								<td height='6'></td>
							</tr>
		...
		$str .= "
							...
							<tr>
								<td height='18' class='evfont'><span class='shopname'><img src='" . __HTTPURL__  . "/img/icon_score.gif'  align='absmiddle' /> <b>$prt_score 점 </b></span></td>
							</tr>
							<tr>
								<td height='18'  class='evfont'><span class='shopname'><img src='" . __HTTPURL__  . "/img/icon_codi.gif'  align='absmiddle' /> <b><font color='#CC3300'>$codi_cnt</font></b></span></td>
							</tr>
						</table>
		...
		<table width='70' border='0' cellspacing='0' cellpadding='0'>
			...
			<tr>
				<td><a href='#' onClick=\"MM_showHideLayers($param_show);\"><img src='" . __HTTPURL__  . "$shop_logo' width='70' height='70' border='0'></a></td>
			</tr>
			<tr>
				<td height='4'></td>
			</tr>
...
$str .= "
						<td width='85' align='center' valign='top'><img src='" . __HTTPURL__  . "/img/btn_gotop_codi.gif' width='70' height='142' border='0' usemap='#btn_codi' /></td>
					</tr>
				</table>
				</td>
			</tr>
