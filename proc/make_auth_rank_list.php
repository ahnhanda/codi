...
$str = "
      <table width='645' border='0' cellspacing='0' cellpadding='0'>
        <tr>
          <td width='129'><a href='#' onClick=\"loadAuthShopList('default','','','1','');\" onmouseout='MM_swapImgRestore()' onmouseover=\"MM_swapImage('Image23','','/img/tap_shop_ov_01.gif',1);\"><img src='" . __HTTPURL__  . "/img/{$tab_img_1}' width='190' name='Image23' height='30' border='0' id='Image23' /></a></td>
		  <td width='130'><a href='#' onClick=\"loadAuthShopList('stat','','','1','');\" onmouseout='MM_swapImgRestore()' onmouseover=\"MM_swapImage('Image24','','/img/tap_shop_ov_02.gif',1);\"><img src='" . __HTTPURL__  . "/img/{$tab_img_2}' name='Image24' width='190' height='30' border='0' id='Image24' /></a></td>
          ...
          <td><table width='645' border='0' cellspacing='0' cellpadding='0'>
            ...
            <tr>
              <td height='27'><table width='645' border='0' cellspacing='0' cellpadding='0'>
                <tr>
                  <td align='center'><img src='" . __HTTPURL__  . "/img/title10.gif' width='70' height='20'></td>
                  <td width='3' align='center'><img src='" . __HTTPURL__  . "/img/title_line.gif' width='3' height='9'></td>
                  <td width='100' align='center'><img src='" . __HTTPURL__  . "/img/title43.gif' width='70' height='20'></td>
                  <td width='3'><img src='" . __HTTPURL__  . "/img/title_line.gif' width='3' height='9'></td>
                  <td width='130' align='center'><img src='" . __HTTPURL__  . "/img/title11.gif' width='70' height='20'></td>
                  <td width='3'><img src='" . __HTTPURL__  . "/img/title_line.gif' width='3' height='9'></td>
                  <td width='70' align='center'><img src='" . __HTTPURL__  . "/img/title12.gif' width='70' height='20'></td>
                  <td width='3'><img src='" . __HTTPURL__  . "/img/title_line.gif' width='3' height='9'></td>
            ...
            <table width='645' border='0' cellspacing='0' cellpadding='0'>
              <tr>
				...
				<table width='96' height='96' border='0' cellpadding='0' cellspacing='1' bgcolor='#CCCCCC'>
                    <tr>
                      <td bgcolor='#3D3D3D'><<a onClick=\"MM_showHideLayers($param_show);\" style='cursor:hand;'><img src='" . __HTTPURL__  . "$shop_logo' width='95' height='95' border='0'></a></td>
                    </tr>
                </table>
				</td>
                <td  style='padding-left:5;padding-right:8'class='shopname'><a onClick=\"MM_showHideLayers($param_show);\" style='cursor:hand;'>$shop_name</a>
	";

	// 샵 정보 레이어
	$str .= getLayerShopInfo("shopview_list", $cnt, 2, 1, 20, -85, $prt_rank, $shop_url, $shop_name, $shop_mem_id, $param_hide);
