	...
	<td bgcolor='C8C8C8' style='padding:1 1 1 1'><table width='100%' border='0' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF'>
		<tr>
		  <td style='padding:15 15 15 15'><table width='100%' border='0' cellspacing='0' cellpadding='0' style='border:1 dotted #BFBFBF;'>
			  <tr>
				<td style='padding:10 10 10 10' class='intext'><img src='" . __HTTPURL__  . "/img/icon_book.gif' width='14' height='15'  align='absmiddle' /> <b><font color='#00CC33'><u>베스트 코디 </u></font></b> : 코디탑텐에서 회원님들께 높은 평가를 받은 <b><font color='#FF5C5C'><u>코디상품들의 순위</u></font></b>를 확인하실 수 있습니다. 어떤 상품이 <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;좋은 상품인지, 요즘 잘나가는 상품은 어떤 것인지 확인해보세요.</td>
			  </tr>
		  </table></td>
		</tr>
	</table></td>
...
<table width='645' height='48' border='0' cellpadding='0' cellspacing='0'>
	<tr>
		<td><img src='" . __HTTPURL__  . "/img/$c_img' width='113' height='48' border='0'></td>
		<td><a href='#' onClick=\"loadCodiRankSub('T','weekly','$f_date','','');\"><img src='" . __HTTPURL__  . "/img/$ct_img' width='87' height='48' border='0'></a></td>
		<td><a href='#' onClick=\"loadCodiRankSub('B','weekly','$f_date','','');\"><img src='" . __HTTPURL__  . "/img/$cb_img' width='89' height='48' border='0'></a></td>
		<td><a href='#' onClick=\"loadCodiRankSub('O','weekly','$f_date','','');\"><img src='" . __HTTPURL__  . "/img/$co_img' width='130' height='48' border='0'></a></td>
		<td><a href='#' onClick=\"loadCodiRankSub('U','weekly','$f_date','','');\"><img src='" . __HTTPURL__  . "/img/$cu_img' width='133' height='48' border='0'></a></td>
		<td><a href='#' onClick=\"loadCodiRankSub('A','weekly','$f_date','','');\"><img src='" . __HTTPURL__  . "/img/$ca_img' width='93' height='48' border='0'></a></td>
	</tr>
</table>
...
<table width='645' border='0' cellspacing='0' cellpadding='0'>
	<tr>
		<td width='129'><a href='#' onClick=\"loadCodiRankSub('$categ','weekly','$this_w_first','$key','$kwd');\" onmouseout='MM_swapImgRestore()' onmouseover=\"MM_swapImage('Image52','','/img/tap_codi_ov_01.gif',1);\"><img src='" . __HTTPURL__  . "/img/{$term_tab_1}' name='Image52' width='129' height='30' border='0' id='Image52' /></a></td>
		<td width='130'><a href='#' onClick=\"loadCodiRankSub('$categ','monthly','$this_m_first','$key','$kwd');\" onmouseout='MM_swapImgRestore()' onmouseover=\"MM_swapImage('Image53','','/img/tap_codi_ov_02.gif',1);\"><img src='" . __HTTPURL__  . "/img/{$term_tab_2}' name='Image53' width='131' height='30' border='0' id='Image53' /></a></td>
		<td width='130'><a href='#' onClick=\"loadCodiRankSub('$categ','','','$key','$kwd');\" onmouseout='MM_swapImgRestore()' onmouseover=\"MM_swapImage('Image54','','/img/tap_codi_ov_03.gif',1);\"><img src='" . __HTTPURL__  . "/img/{$term_tab_3}' name='Image54' width='131' height='30' border='0' id='Image54' /></a></td>
...
if ( $term ) {
	$str .= "
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				<td width='62'><a href='#' onClick=\"loadCodiRankSub('$categ','$term','$ptr_prev_first','$key','$kwd');\"><!--<img src='" . __HTTPURL__  . "/img/btn_a01.gif' width='50' height='14' border='0'>--><font size='-2'>".str_replace("-",".",$ptr_prev_first)."<br>".str_replace("-",".",$ptr_prev_last)."</font></a></td>
				<td width='62'><a href='#' onClick=\"loadCodiRankSub('$categ','$term','$f_date','$key','$kwd');\"><!--<img src='" . __HTTPURL__  . "/img/btn_a03.gif' width='50' height='14' border='0'>--><font size='-2'>".str_replace("-",".",$f_date)."<br>".str_replace("-",".",$l_date)."</font></a></td>
				<td><a href='#' onClick=\"loadCodiRankSub('$categ','$term','$ptr_next_first','$key','$kwd');\"><!--<img src='" . __HTTPURL__  . "/img/btn_a02.gif' width='50' height='14' border='0'>--><font size='-2'>".str_replace("-",".",$ptr_next_first)."<br>".str_replace("-",".",$ptr_next_last)."</font></a></td>
			</tr>
		</table>
	";
} else {
...
while ( $row = $mainconn->fetch($res) ) {
	...
	if ( $cnt == 1 ) {
		if ( $shop_medal == "Y" ) {
			$shop_medal_mark = "<img src='" . __HTTPURL__  . "/img_seri/icon_ks_mini.gif' border='0' align=absmiddle />";
		} else {
			$shop_medal_mark = "&nbsp;";
		}
				...
				<table width='100%' border='0' cellspacing='0' cellpadding='0'>
					<tr>
						...
						<table border='0' cellspacing='0' cellpadding='0'>
							...
							<tr>
								<td height='18' class='shopname'><img src='" . __HTTPURL__  . "/img/icon_shop.gif'  align='absmiddle' /> <b><a href='#'  onClick=\"MM_showHideLayers($param_show);\">$shop_name</a> $shop_medal_mark</b>
		";

		// 샵 정보 레이어
		$str .= getLayerShopInfo("shopview", $cnt, 2, 1, 125, -85, $prt_rank, $shop_url, $shop_name, $shop_mem_id, $param_hide);
		...
		if ( $shop_medal == "Y" ) {
			$auth_td = "<td width='20' rowspan='2' valign='top' bgcolor='#FFFFFF' class='shopname'><img src='" . __HTTPURL__  . "/img_seri/icon_ks_mini.gif' border='0' align=absmiddle /></td>";
		} else {
		...
		<table width='70' border='0' cellspacing='0' cellpadding='0'>
			...
			<tr>
				...
				<table width='100%' border='0' cellpadding='0' cellspacing='0' bgcolor='D9D9D9'>
					<tr>
						$auth_td
						<td align='right' bgcolor='#FFFFFF' class='shopname'><b><a href='#' onClick=\"MM_showHideLayers($param_show);\"><span  style='cursor:hand;'>$shop_name</span></a></b>
		";

		// 샵 정보 레이어
		$str .= getLayerShopInfo("shopview", $cnt, 2, 1, 1, -85, $prt_rank, $shop_url, $shop_name, $shop_mem_id, $param_hide);
...
for ( $i=$cnt; $i<11; $i++ ) {
	...
	$str .= "
		...
		<table width='70' border='0' cellspacing='0' cellpadding='0'>
			...
			<tr>
				<td><img src='" . __HTTPURL__  . "/img/photo_no.gif' width='70' height='70' border='0' /></td>
			</tr>
			<tr>
				<td height='4'></td>
			</tr>
...
$str .= "
						<td width='85' align='center' valign='top'><a href='#' onClick='go_best_shop();'><img src='" . __HTTPURL__  . "/img/btn_gotop_best.gif' width='70' height='142' border='0' /></a></td>
					</tr>
				</table>
				</td>
			</tr>
