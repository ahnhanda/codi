      ...
      <table width="645" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><table width="645" border="0" cellspacing="0" cellpadding="0">
              ...
              <table width="645" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="70" height="26" align="center">3</td>
                 
                  <td align="center" style="padding:5 5 5 5"><a href="board_view.php">맑은날 야외 데이트에 딱 어울리는 주름치마/배색일자</a></td>
                  <td width="73" align="center" >홍길동</td>
                  <td width="83" align="center">2008.6.20</td>
                  <td width="72" align="center">20</td>
                </tr>
                <tr>
                  <td height="1" colspan="5" align="center" bgcolor="E9E9E9"></td>
                </tr>
				 <tr>
                  <td width="70" height="26" align="center">2</td>
                 
                  <td align="center" style="padding:5 5 5 5"><a href="#">맑은날 야외 데이트에 딱 어울리는 주름치마/배색일자</a></td>
                  <td width="73" align="center" >홍길동</td>
                  <td width="83" align="center">2008.6.20</td>
                  <td width="72" align="center">20</td>
                </tr>
                <tr>
				 ...
				 <tr>
                  <td width="70" height="26" align="center">1</td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="24" align="right" valign="bottom"><a href="board_write.php"><img src="img/btn_write.gif" width="60" height="20" border="0" /></a></td>
                </tr>
            </table>
