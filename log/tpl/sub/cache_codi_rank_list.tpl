...
<table width='645' border='0' cellspacing='0' cellpadding='0'>
	<tr>
		...
		<table width='100%' height='45' border='0' cellpadding='0' cellspacing='0'>
			<tr>
				<td align='center'>
<img src='/img/btn_first_go2.gif' width='20' height='16' border='0' align='absmiddle' /><img src='/img/btn_prev6.gif' width='44' height='16' border='0' align='absmiddle' />&nbsp;&nbsp;<a style='cursor:hand;' onClick="loadCodiRankSubList('','weekly','2012-02-26','','','2');"><img src='/img/btn_next6.gif' width='44' height='16' border='0' align='absbottom' /></a><img src='/img/btn_end_go2.gif' width='20' height='16' border='0' align='absmiddle' />
				</td>
			</tr>
		</table>
		</td>
