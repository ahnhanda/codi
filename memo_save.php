  ...
  <tr>
    ...
    <td valign="top"><table width="645" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="img/bar03.gif"><b><font color="FFFC11">[쪽지함] 쪽지 보관함 :</font></b> <font color="#FFFFFF">전체 20개의 보관 쪽지가 있습니다.</font> </td>
          ...
          <td><table width="645" border="0" cellspacing="0" cellpadding="0">
              ...
              <table width="645" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="122" align="center" ><a href="#" onclick="MM_openBrWindow('pop_memo_send.php','','width=500,height=314')">askdfjakf(홍길동)</a></td>
                  <td width="80" align="center">받은쪽지</td>
               
                  <td style="padding-left:8"><a href="#" onclick="MM_openBrWindow('pop_memo_read.php','','width=500,height=365')">내용의 앞부분이 노출됩니다. 한줄로 표시</a></td>
                ...
                <tr>
                  ...
                  <td align="center">보낸쪽지</td>
               
                  <td style="padding-left:8"><a href="#">내용의 앞부분이 노출됩니다. 한줄로 표시</a></td>
                  <td width="123" align="center" class="date">2008-06-20 (15:05)</td>
                </tr>
				<tr>
                  <td height="1" colspan="5" bgcolor="E9E9E9"></td>
			...
			<tr>
              ...
              <tr>
                <td height="25" bgcolor="F6F5F5" style="padding-top:3"  class="intext">&nbsp;※ 최대 100까지 보관이 가능합니다.</td>
              </tr>
              <tr>
                <td height="1" bgcolor="DADADA"></td>
              </tr>
