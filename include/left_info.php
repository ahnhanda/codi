...
<table width="200" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><img src="/coditop/img/left_info_title.gif"></td>
  </tr>
  <tr>
    <td align="center" background="/coditop/img/left_bg01.gif"><table width="170" border="0" cellpadding="0" cellspacing="1" bgcolor="DCDCDC">
      <tr>
        <td height="26" bgcolor="F6F6F6" style="padding-left:10"><img src="/coditop/img/<?=$left_icon_info?>" width="10" height="10" align="absmiddle"> <a href="/info/info.php">사이트 소개 </a></td>
      </tr>
      ...
      <table width="170" border="0" cellpadding="0" cellspacing="1" bgcolor="DCDCDC">
        <tr>
          <td height="26" bgcolor="F6F6F6" style="padding-left:10"><img src="/coditop/img/<?=$left_icon_guide?>" width="10" height="10" align="absmiddle"> <a href="/info/user_guide.php">사이트 이용안내 </a></td>
        </tr>
      </table>
      ...
      <table width="170" border="0" cellpadding="0" cellspacing="1" bgcolor="DCDCDC">
        <tr>
          <td height="26" bgcolor="F6F6F6" style="padding-left:10"><img src="/coditop/img/<?=$left_icon_policy?>" width="10" height="10" align="absmiddle"> <a href="/info/home_guide.php">이용약관</a></td>
        </tr>
      </table>
      <table width="100" height="4" border="0" cellpadding="0" cellspacing="0">
        <tr>
      ...
      <table width="170" border="0" cellpadding="0" cellspacing="1" bgcolor="DCDCDC">
        <tr>
          <td height="26" bgcolor="F6F6F6" style="padding-left:10"><img src="/coditop/img/<?=$left_icon_protect?>" width="10" height="10" align="absmiddle"> <a href="/info/home_protect.php">개인정보보호정책 </a></td>
        </tr>
      </table>
	  <table width="100" height="4" border="0" cellpadding="0" cellspacing="0">
        <tr>
      ...
      <table width="170" border="0" cellpadding="0" cellspacing="1" bgcolor="DCDCDC">
        <tr>
          <td height="26" bgcolor="F6F6F6" style="padding-left:10"><img src="/coditop/img/<?=$left_icon_contact?>" width="10" height="10" align="absmiddle"> <a href="/info/home_join.php">제휴 및 문의 </a></td>
        </tr>
      </table>
    </td>
  </tr>
