...
$sql = "select count(*) from tblMember where mem_id = '$id' and mem_pwd = '$pwd' and mem_status = 'Y' ";
...
if ( $cnt == "0" ) {
	...
	$sql = "select mem_id,mem_name,mem_kind,mem_jumin,mem_email,mem_mobile from tblMember where mem_id = '$id' and mem_pwd = '$pwd' ";
